#+TITLE: 28 October 2023 - 03 November 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit IV - Linear Systems
* wood chips
Continuing.
* Kiki laptop
** more or less done
...
** Done
* SCZ Front Step
** Stupid drywall pieces removed and space filled to masonry gap filler
** Sub-sill pieces (re-)cut and placed
** Door sill roughed out (not too happy with result; maybe prototype)
* Squish
Arch installed
* Abby
** Plan to install arch and use slurm for job submission
Various projects (gcc-em,wktpqb) were very compute intensive, hope is
using slurm will facilitate these types of projects.
* Tuffy
** Arch installed planned.
* Piper
** Arch installed planned.
* EPLDH
