#+TITLE: 08 July 2023 - 14 July 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit II - Pure Resonance
* wktplot
** Support plotting points as markers
** Fix rr.wkt target wktrand path
** Support LinearRing
* wktpqb
** improved performance
Using large hash tables.
** Fixed isometry bugs
Fun making floating point have group behavior.
** Studying generalized lattice generation
May simplify approach to lattice and transform groups and generalize
rectangular and triangular meshes.
* pqbdoc
** Added patch information
** Added 4 and 5 edge diagrams
** Studying how to manage combinatorial explosion
* epldh
Generalizing dihedral group stuff.
* pitch fork
Made pitch fork handle with 3/4" conduit and #10 screw.
3 minute job because the conduit was allready an OK length and
had a hole in the right place - totally by accident.
* wood chips
Starting spreading wood chips on SJ property. Probably take the
rest of the year.
* MJK Memorial
Starting planning.
* wktcolor
