#+TITLE: 26 August 2023 - 01 September 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit III - Step and Delta Functions
* bwmse
** Add Step/Depta Functions
* wood chips
Continuing. Back Side almost done.
* MJK Burial
** 17 Oct 23 1400
* SCZ Front Step
** Fabricating Threshold (oak)
** Fabricating Subthreshold (Chakte Viga)
* EPLDH
** Quadratic integers too involved because of the transform denominator
** MPFI interval arithmetic may be a better alternative
* wktpqb
** Start FP implementation using MPFI architecture
** May use MPFI if problems with colinearity calculations
* Compilers
