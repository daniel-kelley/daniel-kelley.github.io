#+TITLE: 11 March 2023 - 17 March 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit I - Sinusoidal Functions
*** bwmse update
* Ada/SPARK
** GCC Abandoned
...
* Faust/yaml
The goal is to determine if there is a kind of (YAML based) IR that
can be transformed into exising Faust backend code. Starting with C++
backend as a template.
* Mill Controller #2
