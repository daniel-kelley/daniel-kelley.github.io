#+TITLE: 20 May 2023 - 26 May 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit I - Exam 1, con't
**** Actual exam actually complete. PASS.
* ca-r
CA covid-19 case CSV file put back the 'cases' columns. Sheesh.
* San Jose fence
North property line fence blew over in March windstorm. Collaborating
with neighbor to fix the fence ourselves.
** Cleaned up rails
** Made small concrete form for top
** Found post hole digger
* wktcolor
https://github.com/daniel-kelley/wktcolor/issues/10
* wktpqb
** "WKT format patchwork quilt blocks" generator design started.
* Compilers
