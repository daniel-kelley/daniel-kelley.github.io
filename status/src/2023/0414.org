#+TITLE: 08 April 2023 - 14 April 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit I - First Order Autonomous Differential Equations
* Compilers
** EBNF parser/code generator parser (bison)/lexer done.
** Dot file extractor (extract-dot)
* Annie's Pottery Wheel
Bat pin holes done. Pins need to be shortened.
* Mill Controller #2
