#+TITLE: 19 August 2023 - 25 August 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit III - Periodic Input
* wood chips
Continuing. Back Side almost done.
* MJK Burial
** Eligibility Determined at CCCVC
** Hashing out dates with family
* SCZ Front Step
** Locating source for threshold
** Subthreshold to be fabricated
** Checking for materials in SJ
* EPLDH
