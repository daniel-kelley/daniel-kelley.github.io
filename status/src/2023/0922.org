#+TITLE: 16 September 2023 - 22 September 2023
...
** 17 Oct 23 1400
* SCZ Front Step
** Removed termite damaged members
** started cleaning glass
** prototyping door sill cuts
* EPLDH
** MPFI interval arithmetic better alternative
* wktpqb
** Verifying edge construction
** May have a new edge algorithm using 'gcd'
* Posit
** Studying 'valids'.
