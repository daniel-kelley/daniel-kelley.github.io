#+TITLE: 11 November 2023 - 17 November 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit IV - Qualitative Behavior: Phase Portraits
* wood chips
Continuing.
* SCZ Front Step
** Door sill to SJ to clean up
*** Moved tablesaw instead of rotated to accomodate.
*** Still messed it up. Grr.
*** Need to get more material. Oh well.
* Next arch installs
** M22 (AMD kavari box)
** Various i686
...
** time better spent on opencl on supported hardware
* quilt block rearrangement (done)
** arrangement by hand good enough
** probably better to have a 'verifier' than an arranger program
* opencl
