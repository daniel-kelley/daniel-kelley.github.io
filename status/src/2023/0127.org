#+TITLE: 21 January 2023 - 27 January 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit I - Geometric Methods, Con't
* Ada/SPARK
Full Ada cross compiler on sparc buildable. Debugging application
builds in preparation of running ada validation suite.
* Mill Controller #2
