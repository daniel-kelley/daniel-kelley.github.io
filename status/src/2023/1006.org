#+TITLE: 30 September 2023 - 06 October 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit III - (Laplace) Solving Initial Value Problems
* wood chips
Continuing.
* MJK Burial
** 17 Oct 23 1400
* SCZ Front Step
** Sind window patch glued in
* EPLDH
...
* bwmse
https://github.com/daniel-kelley/bwmse/pull/16
* Forth Floating Point
** Ended consideration
Need to finish pqb first!
* Compilers
