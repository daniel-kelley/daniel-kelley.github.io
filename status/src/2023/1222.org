#+TITLE: 16 December 2023 - 22 December 2023
...
Textbook Ordered.
* bwmse
** Updates resulting from 18.03 review
* wood chips
No progress. Rainy...
* SCZ Front Step
No progress. Rainy...
...
** httpd
*** Occassionally served zero length files. Restart fixes.
*** Seems to have been stable for a week.
** SSL cert
...
** Found "rogue" connected device.
It was the Asus tablet. Doy-oy-oy!
** Update
Sometime next year.
* SJC weather station
** Fixed SSH known-host error
** Cleaned out rain gauge
** Still having wireless connectivity problems
Never worked very well anyway.
Really should replace wireless connection with cable.
...
* cipher-puzzle
** verified using org mode for README
