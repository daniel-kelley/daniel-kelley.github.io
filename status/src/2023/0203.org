#+TITLE: 28 January 2023 - 03 February 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit I - Geometric Methods (problem sets), Con't.
sagemath methodology mostly worked out.
* Ada/SPARK
RTEMS/Ada cross target application buildable. Native test suite
applications pass. Designing approach to running test suite on
sparc/erc32 sis simulator.
* Christmas Bear Connector
Rebuilding 'Christmas Bear' holiday decoration power supply connector.
Original connector (wiring) was quite delicate.
* Plasma TV mount
Platform mount modified and installed.
* Some 'kiki' annoyances resolved
** Now can print to Trish's printer
** 'ispell' now checks in Americal english
* Mill Controller #2
...
>>>>>>> 185fcf1c40678b81f13f0fbb1b656f04d043ca90
