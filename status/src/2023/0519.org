#+TITLE: 19 May 2023 - 25 May 2023

* MIT OCW
** 18.03sc (differential equations).
*** Unit I - Exam 1, con't
**** Practice exam completed, graded and corrected.
**** Actual exam nearly complete.
* Status Pages
Added facility to create the weekly status page template with 'make next'
* ca-r
CA covid-19 case CSV file removed the 'cases' columns.
https://github.com/daniel-kelley/ca-r/issues/36
* San Jose fence
North property line fence blew over in March windstorm. Collaborating
with neighbor to fix the fence ourselves.
** Completed fence section demolition
** Aquired replacement materials
* Reading
** A Hacker's Mind
