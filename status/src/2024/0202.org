#+TITLE: 27 January 2024 - 02 February 2024

* MIT OCW
** 18.06sc (Linear Algebra)
*** Unit I - Elimination with Matrices
...
Numerous tweaks.
* Rhapsody Converter
After some fiddling, there's some format misunderstanding.
* Compilers
** Work out overall plan.
Lots of moving pieces.
** Looking into LLVM MLIR.
May not use immediately, but perhaps trend in that direction.
* Various i686
*** netbsd
