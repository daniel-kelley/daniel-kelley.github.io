#+TITLE: 07 September 2024 - 13 September 2024

* MIT OCW
** 18.06sc (Linear Algebra)
*** Unit III: Left and Right Inverses; Pseudoinverse
* SJ grounds
Too Busy.
...
* Mill
** Mark working on getting the new mesa board running.
** WIFI configured
** Helped with linuxcnc configuration
* EDA workflow
** FPGA programming
** RV32I
