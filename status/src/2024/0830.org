#+TITLE: 24 August 2024 - 30 August 2024

* MIT OCW
** 18.06sc (Linear Algebra)
*** Unit III: Linear Transformations and their Matrices
* SJ grounds
Too Busy.
* EDA workflow
** FPGA programming
...
* Quanta Puzzle
Simulated primary puzzle in https://www.quantamagazine.org/perplexing-the-web-one-probability-puzzle-at-a-time-20240829/
and got a result different than described. Not sure why.
* Lapuz Peking/Panerus
Discussion with Ray Lapuz on adapting a new set of peking and panerus
keys to some existing cases.
** RTX-2000
