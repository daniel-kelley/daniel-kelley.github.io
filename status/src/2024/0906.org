#+TITLE: 31 August 2024 - 06 September 2024

* MIT OCW
** 18.06sc (Linear Algebra)
*** Unit III: Change of Basis; Image Compression
* SJ grounds
Too Busy.
* EDA workflow
** FPGA programming
...
***** riscv-torture
Hardwired for RV64. Using picorv32 patches to generate test cases.
**** Compare with a pipelined implementation
Still thinking about it.
* Lapuz Peking/Panerus
May work on this on Sunday.
** RTX-2000
