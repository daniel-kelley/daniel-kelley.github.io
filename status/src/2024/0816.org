#+TITLE: 10 August 2024 - 16 August 2024

* MIT OCW
** 18.06sc (Linear Algebra)
*** Unit III: Similar Matrices and Jordan Form
* SJ grounds
Too Busy.
* EDA workflow
** FPGA programming
...
separately.
*** 'almanor' RV32I
**** BRAM register file implementation ~1800 cells (~1200 LUTs, 600 FFs)
Not too happy with the result. Messier than expected.
**** Refactoring
Trying to understand what's driving the gate count.
** RTX-2000
...
64 bit value.
* SCZ Front Step
** Needs angled cuts on door end.
Has angled cut on window end.
