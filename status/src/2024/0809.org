#+TITLE: 03 August 2024 - 09 August 2024

* MIT OCW
** 18.06sc (Linear Algebra)
*** Unit III: Positive Definite Matrices and Minima
* SJ grounds
Too Busy.
* EDA workflow
** FPGA programming
...
number.
*** 'almanor' RV32I
**** Initial implementation with all opcodes tested at ~4800 cells.
**** Working out register file. This will definitely add more states.
**** Need to understand register file tradeoffs.
** RTX-2000
...
recoverable.
**** Ordered video dongle.
May help in further analysis. I don't think my analog monitors work
anymore, but maybe I'm wrong. Worth checking.
* Cross compilers
