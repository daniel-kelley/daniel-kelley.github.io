#+TITLE: 24 February 2024 - 01 March 2024

* MIT OCW
** 18.06sc (Linear Algebra)
*** Unit I - Column Space and Nullspace
*** Premutation matricies
n=9 ran for 5 days with no solution and massing swapping. Started looking into
Julia, partly because of distributed computing support, but AMDGPU interface
fails testing, so maybe not ready for me yet.
* wood chips
Rainy.
* SCZ Front Step
