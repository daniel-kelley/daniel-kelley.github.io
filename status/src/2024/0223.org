#+TITLE: 17 February 2024 - 23 February 2024

* MIT OCW
** 18.06sc (Linear Algebra)
*** Unit I - Transposes, Permutations, Vector Spaces
*** Investigated some properties of permutation matricies
The number of permutation matricies P of order n such that P^n=I
appears to be related to https://oeis.org/A074351
* wood chips
Rainy.
* SCZ Front Step
...
https://www.simonandschuster.net/books/Grace-in-All-Simplicity/Robert-N-Cahn/9781639364817

* Piper dovecot
** Update broke dovecot auth.
Looks PAM related, but PAM update failed to
fix.
** Set tuffy up as a staging server
So I don't debug on 'production'.
** piper dovecot SSL certificate broken
/etc/ssl/private/dovecot.pem: OpenSSH private key (no password)
Unknown if related, but it may explain other dovecot problems.  Will
look into more robust cert management, since this is a problem that
needs to be solved anyway for openvpn.
* Various i686
*** netbsd
