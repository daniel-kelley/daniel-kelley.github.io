#+TITLE: 03 February 2024 - 09 February 2024

* MIT OCW
** 18.06sc (Linear Algebra)
*** Unit I - Multiplication and Inverse Matrices
* wood chips
Rainy.
* SCZ Front Step
...
** ASDL
Basically a 1997 version of MLIR written mostly in ML (anyone remember
that?).  Original version of asdlGen has bitrotted beyond immediate
usability, but smlnj (http://smlnj.cs.uchicago.edu/) has a version
that works, albeit only for SML and C++. Python3 also has a Python
specific compiler. Investigating the difficulty of an ASDL compiler
targeting 'C'.
* Various i686
*** netbsd
