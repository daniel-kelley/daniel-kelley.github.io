#+TITLE: 14 September 2024 - 20 September 2024

* MIT OCW
** 18.06sc (Linear Algebra)
*** Unit III: Exam 3 review
* SJ grounds
** Water leak
Need to fix water leak at copper/galvanize junction - installed by Royal
Plumbing. Really, guys?
* Lapuz Peking/Panerus
Laid out keys. Keys are to big for Burhan's "restaraunt" cases. Ray to
think about the next steps.
* Mill
** New mesa board running.
** Ordered new Y axis servo and controller.
* EDA workflow
** FPGA programming
** RV32I
