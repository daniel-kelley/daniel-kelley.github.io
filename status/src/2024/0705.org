#+TITLE: 29 June 2024 - 05 July 2024

* MIT OCW
** 18.06sc (Linear Algebra)
*** Unit II: Markov Matrices; Fourier Series
* SJ grounds
Too Hot!
* SCZ Front Step
** Test piece right side fitting continues
** Target piece roughed out to width; bevel cut
...
** FPGA programming
*** lattice workfow refinement (testbenches)
*** simple interconnect circuit tested
*** simple SPI client to 8 bit wishbone bus in development
**** Implementation spiwb0 passes hardware test
**** Implementation spiwb1 passes hardware test
219->136 cells
*** Checked various FF inference tests with ice40 and xilinx targets
*** Studied various ASIC standard cell libraries
