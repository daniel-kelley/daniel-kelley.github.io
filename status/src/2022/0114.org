#+TITLE: 08 January 2022 - 14 January 2022
...
*** Finished U/P Chapter 4 reading.
*** Received materials for 3 Low Voltage Power Supplies
** 21G.701 Spanish
*** Finished Episode 2 'El Secreto'
*** Ordered English/Spanish Dictionary
* CGR-101
** Oscilloscope capture with manual trigger
** Debugging waveform generation
* objgraph
  https://github.com/daniel-kelley/objgraph
* LA County index map
  No changes.
* Mill Controller #2
  Old Controller #1 seems to be operational, but there are OpenGL errors
  with more recent X servers. Probably protocol mismatch. Not sure if Mesa3D
  can handle old clients on new servers.
* WWVB Decoder
  Need to re-think.
...
** Next hearing 14jan2022. Still no PACER. Hearing update unavailable.
* Peter Kim
