#+TITLE: 20 August 2022 - 26 August 2022

* MIT OCW
** 18.02 - Multiple Variable Calculus
*** Session 79-83
* Emergency Crystal Radio
** Need to finish desoldering
* Mill Controller #2
...
*** Logic table to operation 'compiler' mostly complete
*** Nucleo-f303re controller in progress
* More project ideas
...
UART spits out something but may have settings wrong.
*** Etc.
* David Davies
