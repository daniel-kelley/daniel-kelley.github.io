#+TITLE: 19 November 2022 - 25 November 2022
...
* OLPC
** Received ML1220 coin batteries to fix "invalid system date".
* Virtual Orchestra
** sfz file tests
...
*** Done (enough!)
*** Doesn't work well outside (sensors overwhelmed).
* small graphics display
** Integrated TFTP server
** pamtorgb565 converter
** bwif library does not integrate well using file descriptor interface.
** socket server seems unstable (random crashes unless send rate slowed).
