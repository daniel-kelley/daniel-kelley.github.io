#+TITLE: 22 October 2022 - 28 October 2022
...
** Boot problem: blowing dust out fixed.
** Alma linux failed to boot on piper
** need to check rocky, others? for suitability
* OLPC
...
*** Software complete (enough)
*** Ball sensor
Lite-on 15mm slot sensor effective.
*** Rework hardware
**** Eliminate all taped on part mountings (which are most of them!).
**** Use type-t-parts below for some supports (platform server, boards).
*** Display
