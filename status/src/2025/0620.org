#+TITLE: 14 June 2025 - 20 June 2025
...
finished
** hexadecimal float format
** free API cleanups
** started .f()
** demand load expr
** direct mpz_t to mpft_t conversion
** improve floating point test coverage
* SJ grounds
...
** done
* Alcove light
** Thinking about color gradient with 3D Bezier in RGB space
** tried out in alcove
