#+TITLE: 26 April 2025 - 02 May 2025
...
* GMPASM assembler
** took a break this week: frustrated with error message handling
* Alcove light
** tried out in alcove
...
Also noisy.
* TRNG-JB
** built NIST 800-90A analysis programs
** collected data
** validated an AES128CMAC function
