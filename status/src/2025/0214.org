#+TITLE: 08 February 2025 - 14 February 2025

* MIT OCW
** 18.05 - Introduction to Probability and Statistics
*** Started
Scant progress. May refocus on combinatorics. Have assembler-on-the-brain.
* Sonic Fiber
...
** Works woth RIOT OS.
* GMPASM assembler
** total memory PIG. Trying to figure out why
** Using boehm-gc plus memory wrappers
** Most of forth macros characterized
Uncovered a number of memory and lexer problems. Nothing fatal, but
all more work than anticipated. Need to get this to a good state so I
