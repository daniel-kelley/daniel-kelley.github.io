#+TITLE: 19 April 2025 - 25 April 2025
...
** implement .irpc
** implement .rept
** start .section unit tests
** add srec output filters
* Alcove light
** initial prototype complete
** designing 'knob' field adjustment interface
* TRNG-JB
** 1 LM324 relaxation oscillator
** 2 74LS14 relaxation oscillator
Only because I only had 2 1uF caps on hand.
...
* Raspberry Pi Pico
Raspberry Pi 5 configured for Pico development.
* Sonic Fiber
