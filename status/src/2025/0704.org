#+TITLE: 28 June 2025 - 04 July 2025
...
** common v_* support
** float unary ops
** integer GMP operations
** rational GMP operations
** huge .expr mess
*** faults when .expr calls another .expr
*** tried isolating stacks - doesn't help
* SJ grounds
** mulch 75% distributed
** dead trees removed
