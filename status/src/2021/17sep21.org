#+TITLE: 11 September 2021 - 17 September 2021

Even more September-like.

* MIT OCW
** 18.01 - Single Variable Calculus
*** Completed sessions 21-22
*** Completed Exam 1
** 8.01 - Physics I - Classical Mechanics
*** Completed Week 3 - Circular Motion
*** Sage
    Working out how to do physics problems with diagrams.
* Marble Computation
...
None.
* us-index-map
**  Added quad 250k quad names
   https://github.com/daniel-kelley/us-1-2-index-map/issues/1
** started 125k index map
* Sun Ultra 10
